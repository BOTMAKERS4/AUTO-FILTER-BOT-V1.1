...
<b>• ꜰᴜʟʟ ɴᴀᴍᴇ : JM_FILES</b>
<b>• Uꜱᴇʀ ɴᴀᴍᴇ : @jmfilesbot
<b>• Uꜱᴇʀ ɪᴅ  :<b><code>1297128957</code> 
    
<b>∂σи'т вє αfяαι∂ σf вєιиg ∂ιffєяєит, вє αfяαι∂ σf вєιиg тнє ѕαмє αѕ єνєяуσиє єℓѕє</b>
    """

    ABOUT_TXT = """<b>JM_FILES</b>

<b>• ηαмє : JM_FILES
• υѕєя ηαмє : @jmfilesbot
...
<b>╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═══╗
♻️ <a href="https://t.me/JM_FILES"> </a>
♻️ <a href="https://t.me/JM_FILES"> </a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═══╝</b>
"""
    SUR_TXT = """
...
<b>Exᴄʟᴜꜱɪᴠᴇʟʏ Mᴀᴅᴇ Tʜɪꜱ Bᴏᴛ Fᴏʀ @JM_FILES..!! 💫</b>

<b>📌 Sᴜᴘᴘᴏʀᴛ : @JM_FILES</b>

<b>🍂 Oᴡɴᴇʀ : @jmfilesbot</b>"""
...
╔═══ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
♻️<a href=https://t.me/JM_FILES> CHANNEL</a>
♻️<a href=https://t.me/JM_FILES> CHANNEL</a>
╚═══ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
1️⃣ Make sure you type the movie as it is spelled in google..!!
2️⃣When sending a message for a movie, send only the name of the movie..!!

4⃣ ‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @jmfilesbotbot</b> """
...
1️⃣ Make sure you type the movie as it is spelled in google..!!
 ...
 2️⃣When sending a message for a movie, send only the name of the movie..!!</b>"""


    I_CUD_NT = """ʜᴇʟʟᴏ {} ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ.ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ."""
    
    CUDNT_FND = """<b>ʜᴇʟʟᴏ {} BRO Look at the SPELLING below which movie you want and CLICK CURRET...</b>👇🏻"""
